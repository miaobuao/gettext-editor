...
interface LanguageCode<T> {
  code: T;
  name: string;
}

function defineLanguageCodes<T extends string>(codes: LanguageCode<T>[]) {
  return codes;
}

export const ISO_639_1 = defineLanguageCodes([
  { code: 'aa', name: 'Afar' },
...
export type ISO_639_1_LanguageCode = (typeof ISO_639_1)[number]['code'];
